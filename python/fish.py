...
#
#
# SPDX-FileCopyrightText: Copyright (C) David Flatz <david@upcs.at>
...
if (__name__ == "__main__" and import_ok and
    ...
    weechat.hook_modifier("irc_in2_topic", "fish_modifier_in_decrypt_cb", "")
    weechat.hook_modifier("irc_in2_332", "fish_modifier_in_decrypt_cb", "")
